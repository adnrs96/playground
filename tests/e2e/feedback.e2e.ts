...
describe('Feedback', () => {
  ...
  /**
     ...
     * Then I see a feedback-circle icon
     */
  it('should display the feedback icon in toolbar', async () => {
    expect.assertions(1)
    expect(await page.$('#toolbar-feedback')).toBeTruthy()
  })

  /**
     * And When I click the feedback icon
  ...
  it('should display a form in a modal when I click the feedback icon', async () => {
    expect.assertions(4)
    await page.click('#toolbar-feedback')
